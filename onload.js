...
async function b(e, t) {
  if (t) {
    var s = p(t);
    if ((console.log("getTableData:", t, s), !s))
      return (
...
async function N(e, t) {
  ...
  if ((console.log("Element with scrollbar"), console.log(r), !r))
    return void t({ error: "No element with a scrollbar found" });
  let l = !1,
    s = !1,
    a = $(e).children().length,
    i = r.scrollTop;
  ...
  return new Promise(function (t, o) {
    ...
    var c = setInterval(function () {
      ...
      if (
        ...
        return clearInterval(c), void t();
      console.log("Scrolling to: ", n[s]), n[s].scrollIntoView(!1), s++;
    }, a);
  });
}
function S(e, t, o) {
